...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col  pt-20 px-5 md:px-20 pb-4">
      <div className="flex flex-col gap-8 lg:flex-row justify-between pt-20 items-center ">
        <div className=" flex flex-col gap-7 max-w-[430px]">
          ...
          <DescriptionHome>
            ...
            una documentación en archivos <Tag color="text-word-color">word</Tag> o <Tag color="text-secondary">pdf</Tag>, te generamos exámenes a tipo test
